...
$GLOBALS['TL_PURGE']['tables']['tl_geocode_cache'] = array(
    'callback'  => array('Pdir\GeoCodeCacheBundle\Controller\Automator', 'purge'),
 ...
 * Cron Jobs
 */
$GLOBALS['TL_CRON']['daily'][] = array('Pdir\GeoCodeCacheBundle\Controller\Automator', 'deleteOldCoordinates');
